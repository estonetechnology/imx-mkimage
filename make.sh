...
source /mnt/ben/work_imx8/kernel-uboot/4.14.98_2.0.0_GA/sdk/install/environment-setup-aarch64-poky-linux
export ARCH=arm64
...
#cp iMX8M/flash.bin /mnt/ben/work_imx8/kernel-uboot/4.14.98_2.0.0_GA/emb-2238-mfg/mfgtools/Profiles/Linux/OS\ Firmware/files/linux/ 
