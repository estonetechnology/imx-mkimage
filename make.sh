...
cp -vt iMX8M/ ../uboot-imx/spl/u-boot-spl.bin \
	...
	../uboot-imx/arch/arm/dts/est-imx8mm-ppc4210.dtb
cp -v ../uboot-imx/tools/mkimage iMX8M/mkimage_uboot
mv iMX8M/est-imx8mm-ppc4210.dtb iMX8M/fsl-imx8mm-evk.dtb
make clean
...
cp ../linux-imx/arch/arm64/boot/dts/freescale/est-imx8mm-ppc4210.dtb ./uuu/
cp ../linux-imx/install/lib.tar.bz2 ./uuu/
cd uuu
zip -r ../ppc-4210-uuu.zip ./*
cd -
