...
mv iMX8M/est-imx8mm-iob4607.dtb iMX8M/fsl-imx8mm-evk.dtb
make clean
...
cd ../linux-imx
make distclean
make iob4607_defconfig
make -j8
############build uuu dir#####################
cd -
cp iMX8M/flash.bin ./uuu/
cp ../linux-imx/arch/arm64/boot/Image ./uuu/
cp ../linux-imx/arch/arm64/boot/dts/freescale/est-imx8mm-iob4607-lvds-7.dtb ./uuu/
cd uuu
zip -r ../iob4607-uuu.zip ./*
cd -
