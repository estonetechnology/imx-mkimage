...
cd ../uboot-imx
make distclean
make imx8mm_poe2237_v2_defconfig 
make -j8
cd -
############build flash.bin#####################
cp -vt iMX8M/ ../uboot-imx/spl/u-boot-spl.bin \
	...
	../uboot-imx/arch/arm/dts/est-imx8mm-poe2237-v2.dtb
cp -v ../uboot-imx/tools/mkimage iMX8M/mkimage_uboot
mv iMX8M/est-imx8mm-poe2237-v2.dtb iMX8M/fsl-imx8mm-evk.dtb
make clean
...
cp ./uuu/est-imx8mm-poe2237-v2.dtb ./uuu/est-imx8mm-poe2237.dtb
cd uuu
zip -r ../iob-2237-tas-v2-uuu.zip ./*
cd -
